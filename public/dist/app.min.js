...
"use strict";angular.module("app.controllers").controller("mainCtrl",["$scope","$http","$syntax","$timeout","$loader","$socket",function(n,e,t,c,o,i){function u(){e.get("/api/files").success(function(e){n.files=e})}function a(c){e.post("/api/get_file",{path:c.path}).success(function(e){n.currentFile=c,n.fileContent=e,n.syntax=t(c.name)})}function s(e,t){_.find(t,function(t){"directory"==t.type?s(e,t.files):t.path==e&&n.changingFuncs.change(t)})}n.pageTitle="File Watcher",n.currentFile={},n.fileContent="",n.syntax="",n.files={},n.changed=[],n.opened=[],n.openingFuncs={isOpen:function(e){return _.indexOf(n.opened,e.path)!=-1},open:function(e){n.opened.push(e.path)},close:function(e){_.remove(n.opened,function(n){return e.path==n})},toggle:function(e){n.openingFuncs.isOpen(e)?n.openingFuncs.close(e):n.openingFuncs.open(e)}},n.changingFuncs={isChanged:function(e){return _.indexOf(n.changed,e.path)!=-1},change:function(e){n.changed.push(e.path)},unchange:function(e){_.remove(n.changed,function(n){return e.path==n})}},n.$watch("fileContent",function(n,e){c(function(){Prism.highlightAll()},0)}),u(),n.choose=function(e){a(e),n.changingFuncs.unchange(e)},i.on("connected",function(){console.log("Connected!",i.obj.id)}),i.on("fschange",function(e){console.log("fschange",e),n.currentFile.path==e.path?(console.log(n.currentFile.path,e.path,n.currentFile.path==e.path),a(n.currentFile)):s(e.path,n.files)}),i.on("fsupdate",function(){u()})}]);
