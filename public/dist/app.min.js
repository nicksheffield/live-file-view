...
"use strict";angular.module("app.controllers").controller("mainCtrl",["$scope","$http","$syntax","$timeout","$loader","$socket",function(n,e,t,o,i,c){function p(){e.get("/api/files").success(function(e){n.files=e})}function u(o){e.post("/api/get_file",{path:o.path}).success(function(e){n.currentFile=o,"string"==typeof e?n.fileContent=e:n.fileContent=JSON.stringify(e,null,4),n.syntax=t(o.name)})}function a(e,t){_.find(t,function(t){"directory"==t.type?a(e,t.files):t.path==e&&n.changingFuncs.change(t)})}n.pageTitle="File Watcher",n.currentFile={},n.fileContent="",n.syntax="",n.files={},n.changed=[],n.opened=[],n.openFiles=[],n.openingFuncs={isOpen:function(e){return _.indexOf(n.opened,e.path)!=-1},open:function(e){n.opened.push(e.path)},close:function(e){_.remove(n.opened,function(n){return e.path==n})},toggle:function(e){n.openingFuncs.isOpen(e)?n.openingFuncs.close(e):n.openingFuncs.open(e)}},n.changingFuncs={isChanged:function(e){return _.indexOf(n.changed,e.path)!=-1},change:function(e){n.changed.push(e.path)},unchange:function(e){_.remove(n.changed,function(n){return e.path==n})}},n.$watch("fileContent",function(n,e){o(function(){Prism.highlightAll()},0)}),p(),n.choose=function(e,t){t&&2==t.which?n.removeFromTab(e):(u(e),n.changingFuncs.unchange(e),_.find(n.openFiles,{path:e.path})||n.openFiles.push(e))},n.removeFromTab=function(e){n.openFiles=_.reject(n.openFiles,{path:e.path}),n.currentFile.path==e.path&&(n.openFiles.length?n.choose(n.openFiles[0]):(n.currentFile={},n.syntax=""))},c.on("connected",function(){console.log("Connected!",c.obj.id)}),c.on("fschange",function(e){console.log("fschange",e),n.currentFile.path==e.path?(console.log(n.currentFile.path,e.path,n.currentFile.path==e.path),u(n.currentFile)):a(e.path,n.files)}),c.on("fsupdate",function(){p()})}]);
