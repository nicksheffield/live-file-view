...
"use strict";angular.module("app.controllers").controller("mainCtrl",["$scope","$http","$syntax","$timeout","$loader","$socket",function(n,t,e,o,c,i){function l(o){t.post("/api/get_file",{path:o.path}).success(function(t){n.currentFile=o,n.fileContent=t,n.syntax=e(o.name)})}n.pageTitle="Your MEAN website",n.currentFile={},n.fileContent="",n.syntax="",n.$watch("fileContent",function(n,t){o(function(){Prism.highlightAll()},0)}),t.get("/api/files").success(function(t){n.files=t}),n.choose=function(n){l(n)},i.on("connected",function(){console.log("Connected!",i.obj.id)}),i.on("fschange",function(t){console.log("fschange",t),n.currentFile.path==t.path?(console.log("match"),l(n.currentFile)):console.log("no match")})}]);
"use strict";angular.module("app.directives").directive("fileNavItem",["$recursion",function(e){function t(e,t,c){e.open=!1,t.find(".name").on("click",function(){"directory"==e.data.type?(e.open=!e.open,e.$apply()):e.choose(e.data)})}return{restrict:"E",replace:!1,transclude:!1,templateUrl:"angular/directives/fileNavItem.html",compile:function(c){return e.compile(c,t)},scope:{data:"=",choose:"=",current:"="}}}]);
