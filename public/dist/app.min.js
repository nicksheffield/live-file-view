...
"use strict";angular.module("app.controllers").controller("mainCtrl",["$scope","$http","$syntax","$timeout","$loader","$socket",function(n,e,t,o,i,c){function s(){e.get("/api/files").success(function(e){n.files=e,n.openingFuncs.open(n.files[0])})}function l(o){var i=o.name.split(".");e.post("/api/get_file",{path:o.path}).success(function(e){"jpg"==i[i.length-1]||"gif"==i[i.length-1]||"png"==i[i.length-1]?(o.imageurl="http://"+location.hostname+":3333/"+o.shortpath.replace(/\s/g,"%20"),n.currentFile=o,n.syntax=""):(n.currentFile=o,"string"==typeof e?n.fileContent=e:n.fileContent=JSON.stringify(e,null,4),n.syntax=t(o.name))})}function p(e,t){_.find(t,function(t){"directory"==t.type?p(e,t.files):t.path==e&&n.changingFuncs.change(t)})}n.pageTitle="File Watcher",n.currentFile={},n.fileContent="",n.syntax="",n.files={},n.changed=[],n.opened=[],n.openFiles=[],n.openingFuncs={isOpen:function(e){return _.indexOf(n.opened,e.path)!=-1},open:function(e){n.opened.push(e.path)},close:function(e){_.remove(n.opened,function(n){return e.path==n})},toggle:function(e){n.openingFuncs.isOpen(e)?n.openingFuncs.close(e):n.openingFuncs.open(e)}},n.changingFuncs={isChanged:function(e){return _.indexOf(n.changed,e.path)!=-1},change:function(e){n.changed.push(e.path)},unchange:function(e){_.remove(n.changed,function(n){return e.path==n})}},n.$watch("fileContent",function(n,e){o(function(){Prism.highlightAll()},0)}),s(),n.choose=function(e,t){console.log("choose"),t&&2==t.which?n.removeFromTab(e):(l(e),n.changingFuncs.unchange(e),_.find(n.openFiles,{path:e.path})||(n.openFiles.push(e),console.log("tabs",n.openFiles)))},n.removeFromTab=function(e){n.openFiles=_.reject(n.openFiles,{path:e.path}),n.currentFile.path==e.path&&(n.openFiles.length?n.choose(n.openFiles[0]):(n.currentFile={},n.syntax=""))},c.on("connected",function(){console.log("Connected!",c.obj.id)}),c.on("fschange",function(e){console.log("fschange",e),n.currentFile.path==e.path?(console.log(n.currentFile.path,e.path,n.currentFile.path==e.path),l(n.currentFile)):p(e.path,n.files)}),c.on("fsupdate",function(){s()})}]);
